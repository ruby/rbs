...
/* templates/ext/rbs_extension/ruby_objs.c.erb                                */
/*----------------------------------------------------------------------------*/
...
VALUE rbs_function(VALUE required_positional_params, VALUE optional_positional_params, VALUE rest_positional_params, VALUE trailing_positional_params, VALUE required_keywords, VALUE optional_keywords, VALUE rest_keywords, VALUE return_type) {
  VALUE kwargs = rb_hash_new();
  rb_hash_aset(kwargs, ID2SYM(rb_intern("required_positionals")), required_positional_params);
  rb_hash_aset(kwargs, ID2SYM(rb_intern("optional_positionals")), optional_positional_params);
  rb_hash_aset(kwargs, ID2SYM(rb_intern("rest_positionals")), rest_positional_params);
  rb_hash_aset(kwargs, ID2SYM(rb_intern("trailing_positionals")), trailing_positional_params);
  rb_hash_aset(kwargs, ID2SYM(rb_intern("required_keywords")), required_keywords);
  rb_hash_aset(kwargs, ID2SYM(rb_intern("optional_keywords")), optional_keywords);
  rb_hash_aset(kwargs, ID2SYM(rb_intern("rest_keywords")), rest_keywords);
  rb_hash_aset(kwargs, ID2SYM(rb_intern("return_type")), return_type);
...
VALUE rbs_ast_members_class_instance_variable(VALUE name, VALUE type, VALUE location, VALUE comment) {
  VALUE kwargs = rb_hash_new();
  rb_hash_aset(kwargs, ID2SYM(rb_intern("name")), name);
  rb_hash_aset(kwargs, ID2SYM(rb_intern("type")), type);
  rb_hash_aset(kwargs, ID2SYM(rb_intern("location")), location);
  rb_hash_aset(kwargs, ID2SYM(rb_intern("comment")), comment);
...
VALUE rbs_ast_members_attr_writer(VALUE name, VALUE type, VALUE ivar_name, VALUE kind, VALUE annotations, VALUE location, VALUE comment, VALUE visibility) {
  ...
  rb_hash_aset(kwargs, ID2SYM(rb_intern("name")), name);
  rb_hash_aset(kwargs, ID2SYM(rb_intern("type")), type);
  rb_hash_aset(kwargs, ID2SYM(rb_intern("ivar_name")), ivar_name);
  rb_hash_aset(kwargs, ID2SYM(rb_intern("kind")), kind);
  rb_hash_aset(kwargs, ID2SYM(rb_intern("annotations")), annotations);
  rb_hash_aset(kwargs, ID2SYM(rb_intern("location")), location);
  rb_hash_aset(kwargs, ID2SYM(rb_intern("comment")), comment);
  rb_hash_aset(kwargs, ID2SYM(rb_intern("visibility")), visibility);
