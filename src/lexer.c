...
#line 162 "src/lexer.re"
        {
            return rbs_next_token(lexer, rbs_mb_ident_type(lexer, 0, tUIDENT, tLIDENT));
        }
...
#line 165 "src/lexer.re"
        {
            return rbs_next_token(lexer, rbs_mb_ident_type(lexer, 1, tULIDENT, tULLIDENT));
        }
