...
void rbs_loc_add_required_child(rbs_allocator_t *, rbs_location_t *loc, rbs_constant_id_t name, range r);
void rbs_loc_add_optional_child(rbs_allocator_t *, rbs_location_t *loc, rbs_constant_id_t name, range r);
