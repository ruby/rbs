...
class Thread < Object
  ...
  # .
  def abort_on_exception=: (bool abort_on_exception) -> any
  ...
  # for more information.
  def pending_interrupt?: (*any args) -> bool
  ...
  # [::report\_on\_exception=](Thread.downloaded.ruby_doc#method-c-report_on_exception-3D)
  # .
  def report_on_exception=: (bool report_on_exception) -> any
  ...
  def self.pending_interrupt?: (*any args) -> bool
