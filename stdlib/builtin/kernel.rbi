...
module Kernel
  ...
  def catch: (?Object tag) { (Object arg0) -> any } -> any
  ...
  def <=>: (any other) -> Integer?

  def ===: (any other) -> bool

  def =~: (any other) -> NilClass
  ...
  def instance_variable_set: (Symbol | String arg0, any arg1) -> any
  ...
  def `public_send`: (Symbol | String arg0, *any args) -> any

  def remove_instance_variable: (Symbol arg0) -> any

  def `send`: (String | Symbol arg0, *any arg1) -> any
            | (String | Symbol arg0, *any arg1) { () -> any } -> any
  ...
  def format: (String format, *any args) -> String
  ...
  def printf: (?IO arg0, ?String arg1, *any arg2) -> NilClass
  ...
  def sprintf: (String format, *any args) -> String

  def syscall: (Integer num, *any args) -> any

  def test: (String cmd, String file1, ?String file2) -> (TrueClass | FalseClass | Time)

  def throw: (Object tag, ?any obj) -> bot
