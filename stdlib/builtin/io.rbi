...
class IO < Object
  ...
  def print: (*any arg0) -> NilClass

  def printf: (String format_string, *any arg0) -> NilClass

  def putc: (Numeric | String arg0) -> any

  def puts: (*any arg0) -> NilClass
  ...
  def self.binwrite: (String name, String arg0, ?Integer offset, ?external_encoding: String external_encoding, ?internal_encoding: String internal_encoding, ?encoding: String encoding, ?textmode: any textmode, ?binmode: any binmode, ?autoclose: any autoclose, ?mode: String mode) -> Integer
  ...
  def self.read: (String name, ?Integer length, ?Integer offset, ?external_encoding: String external_encoding, ?internal_encoding: String internal_encoding, ?encoding: String encoding, ?textmode: any textmode, ?binmode: any binmode, ?autoclose: any autoclose, ?mode: String mode) -> String

  def self.readlines: (String name, ?String sep, ?Integer limit, ?external_encoding: String external_encoding, ?internal_encoding: String internal_encoding, ?encoding: String encoding, ?textmode: any textmode, ?binmode: any binmode, ?autoclose: any autoclose, ?mode: String mode) -> ::Array[String]
  ...
  def self.try_convert: (any arg0) -> IO?

  def self.write: (String name, String arg0, ?Integer offset, ?external_encoding: String external_encoding, ?internal_encoding: String internal_encoding, ?encoding: String encoding, ?textmode: any textmode, ?binmode: any binmode, ?autoclose: any autoclose, ?mode: String mode) -> Integer
