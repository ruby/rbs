...
class File[Elem] < IO
  ...
  def self.birthtime: (any file) -> Time
  ...
  def self.exist?: (any file) -> bool

  def self.expand_path: (any file, ?any dir) -> String
  ...
  def self.stat: (any file) -> File::Stat
